...
export const nav: DefaultTheme.NavItem[] = [
  ...
  },
  {
    ...
    text: '计算机基础',
    items: [
      {text: '计算机组成原理',link: '/Metering/grouping/'}, // 表示docs/Metering/grouping/index.md 
      {text: '操作系统',link: '/Metering/os/'}, // 表示docs/Metering/os/index.md
      {text: '计算机网络',link: '/Metering/network/'}, // 表示docs/Metering/network/index.md
      {text: '数据库',link: '/Metering/database/'}, // 表示docs/Metering/database/index.md
      {text: '数据结构与算法',link: '/Metering/method/'}, // 表示docs/Metering/method/index.md
      {text: '设计模式',link: '/Metering/design/'}, // 表示docs/Metering/design/index.md
    ]
  },
  {
    ...
    text: '测试',
    items: [
      {text: '测试方法与技术',link: '/Test/basic/'}, // 表示docs/Test/basic/index.md
      {
        text: '自动化',
        items: [
      ...
      {text: '性能测试',link: '/Test/performance/'}, // 表示docs/Test/performance/index.md
  ]
  },
  {  
    text: 'python',
